...
import myHeroes, { owners } from "../data/heroes"; // se puede asignar nombre cstm a la importación de exportación por defecto
...
export const getHeroesBayOwner = ( owner: string ) => {
